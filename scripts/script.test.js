...
//test("округление до 1.66666667", () => {expect(calculate("1.66666666666666")).toBe("1.66666667")});
test("53%", () => {expect(calculate("53%")).toBe("0.53")});
//test("0.000053%", () => {expect(calculate("0.0000053%")).toBe("0.0000005")});
...
//test("0.000000007+0.000000008 should be 0.00000002", () => {expect(calculate("0.000000007+0.000000008")).toBe("0.00000002")});
...
// test("1.1+2.2", () => {expect(calculate("1.1+2.2")).toBe("3.3")});
